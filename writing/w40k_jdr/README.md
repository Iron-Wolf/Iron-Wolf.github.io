...
6. **Nébuleuse :**
  - 1-2 : malgré le mutisme des Tech-Priest, votre Voidmaster réalise une manoeuvre innatendu. Vous êtes tombé sur un vaisseau Rogue Trader qui a un Navigator qui ne retrouve pas l'Astronomican. Vous leur donner les coordonnées d'un courant Warp. Vous avez le droit à une faveure
  - 3-4 : vous êtes perdu, le voyage est retardé de `1d6` jours
  - 5-6 : nouvel évènement (relancer un d20 sur cette table)
...
11. 
12. 
13. **Pirates :** 1d6 Voyous Humains de base ont réussi à se faufiler à bord du vaisseau et attaquent. Comme l'équipage ne s'attendait à rien, personne n'est protégé par une armure et aucune arme autre qu'un seul pistolet ou une arme de combat rapproché n'est portée. Le reste est stocké dans l'armurerie du vaisseau.
...
19. **Action d'abordage :**
  - 1-2 : une race xeno intélligente tente d'aborder le vaisseau (Tyranide, Ork, Eldar, ...)
  - 3-4 : des tyranides coupés de l'ésprit de la ruche s'attaque au vaisseau
  - 5-6 : ...
20. **signal de détresse :**
...
18. **Vaisseau d'aristocrate :** Compte comme un Vaisseau spatial (#1 ci-dessus) sauf qu'il a le double de l'équipage et de la cargaison
  - 1-2 : Libre Marchand
